...
public class CarrelloDAO {
    ...
    public int doRetriveCarrelloCodByMailCLiente(String mail)  {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    public double doRetrivePrezzoByIdCarrello(int id)  {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    private int getComporreQuantita(int id, int carrelloCod)  {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    public void doUpdateQuantitaRichiestaById(int id, int carrelloCod, int quantita)  {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    public Carrello doRetriveByMailCliente(String mail)  {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    public static void delCarrelloFromComporre(Carrello carrello) {
        Connection con;
		try {
			con = ConPool.getConnection();
   ...
   private static void addCartDB(Prodotto p, int idCarrello) {
        Connection con;
		try {
    ...
    public void updateTotalCarrello(Carrello carrello) {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    public void setOrdineEvaso(int codCarrello, String mail) {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    public void setIndirizzoOrdine(Cliente c, int codCarrello) {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    public void createNewOrdine(Cliente c, int idCarrello) {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    public static ArrayList<Carrello>  doRetriveStorico(String mail) {
        ArrayList<Integer> storicoCarrelli;
		storicoCarrelli = doRetriveStoricoCarrelliIdEvasiByMail(mail);
    ...
    private double getPrezzoRidondanteDaComporre(int carrelloCod, int id)  {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    private List<Prodotto> doRetriveProdottiByIdCarrello(int carrelloCod)  {
    ...
    private ArrayList<Integer> doRetriveListaCodiciProdotti(int carrelloCod) {
    ...
    public Carrello doRetriveCarrelloById(Integer id) {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    private static ArrayList<Integer> doRetriveStoricoCarrelliIdEvasiByMail(String mail) {
    ...
    public void modCart(Carrello cart, Prodotto p) {
        modComporreQuant( cart,  p);
		modCarrelloPrezzo(cart);
        
    }

    private void modCarrelloPrezzo(Carrello cart) {
        Connection con;
		try {
			con = ConPool.getConnection();
    ...
    private void modComporreQuant(Carrello cart, Prodotto p) {
        Connection con;
		try {
			con = ConPool.getConnection();
